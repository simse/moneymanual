	...
	<div class="max-w-5xl mx-auto px-4 py-12">
		<div class="grid grid-cols-1 md:grid-cols-12 gap-8">
			<div class="md:col-span-4">
				...
				<ul class="text-sm">
					<li><a href={searchHref} class={linkCls}>{t(locale, "searchTheSite")}</a></li>
					<li><a href="/sitemap-index.xml" class={linkCls}>{t(locale, "sitemap")}</a></li>
				</ul>
			</div>
			<div class="md:col-span-3">
				<h4 class="font-bold text-zinc-900 mb-3">{t(locale, "topics")}</h4>
				<ul>
		...
		<div class="border-t border-zinc-300 mt-6 pt-5 flex flex-wrap gap-x-6 gap-y-1 text-sm text-zinc-700">
